...
class OurBusinessComponent extends Component {
    ...
    render() {
        ...
        const pkInfraParagraphs = ['We undertake erection, installation and commissioning of EHT(Extra High Tension) powerlines.']
        ...
        const pkParagraphs = ['We are engaged in aquaculture business designed to raise and produce fresh water prawn/shrimps in 100 acres at Balasore.']
        //const pkInfraParagraphs = ['We are engaged in aquaculture business designed to raise and produce fresh water prawn/shrimps','Some powerline projects are in pipeline']
        const pkCollection  = <CollectionComponent className="white black-text" collections={pkParagraphs}/>
        const pkCollapsible = <CollapsibleComponent collapsibles={[{header:'Thriveni and Peekay Mining Co. pvt. ltd.',text:pkCollection}]}/>
        ...
        const businessCollection = <CollectionComponent collections={[miningCollapsible,logisticCollapsible,pkInfraCollapsible,pkCollapsible,softCollapsible]}/>
        return (<div>
                  <NavBar/>
