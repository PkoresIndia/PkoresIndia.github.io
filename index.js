...
class IndexComponent extends Component {
    ...
    render() {
        ...
        const visionComp = (<CollectionComponent className='cyan darken-2' collections={['To be the leading mining company in terms of production and dispatches.','To strive and bring as much value addition to the minerals produced as possible.','To expand the activities beyond India and be a world player.']}/>)
